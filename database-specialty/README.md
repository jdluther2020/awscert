# [Database - Specialty (DBS-C01)](https://aws.amazon.com/certification/certified-database-specialty/)
&#8286; [Certification Home] &#8286;

## PDF Downloads
1. [Download the Exam Guide](https://d1.awsstatic.com/training-and-certification/docs-database-specialty/AWS-Certified-Database-Specialty_Exam-Guide.pdf)
2. [Download the Sample Questions](https://d1.awsstatic.com/training-and-certification/docs-database-specialty/AWS-Certified-Database-Specialty_Sample-Questions.pdf)
3. [Download the AWS Ramp-Up Guide for Database - Specialty](https://d1.awsstatic.com/training-and-certification/ramp-up_guides/Ramp-Up_Guide_Databases.pdf)
...
-->
### Optional Training
6. [Amazon E-Learning- 10 to 20 minute videos to teach fundamentals by each service](https://www.aws.training/LearningLibrary?query=&filters=Domain%3A107%20Language%3A1%20DeliveryFormat%3A1%2C4%2C6%2C7%2C8&from=0&size=15&sort=_score://www.aws.training/LearningLibrary?query=&filters=Domain%3A71%20Language%3A1%20DeliveryFormat%3A1%2C4%2C6%2C7%2C8&from=0&size=15&sort=_score)
7. [A CLOUD GURU- LEARNING PATH - Data](https://learn.acloud.guru/learning-path/aws-data)
...
9. [AWS Database Migration Service Best Practices](https://d1.awsstatic.com/whitepapers/RDS/AWS_Database_Migration_Service_Best_Practices.pdf)
10. [Migration Strategy for Relational Databases](https://docs.aws.amazon.com/prescriptive-guidance/latest/database-migration-strategy/welcome.html)
11. [Best Practices for Running Oracle Database on AWS](https://d1.awsstatic.com/whitepapers/best-practices-for-running-oracle-database-on-aws.pdf)
12. [Deploying Microsoft SQL Server on Amazon Web Services](https://d1.awsstatic.com/whitepapers/RDS/Deploying_SQLServer_on_AWS.pdf)
13. [Getting Started with Amazon DocumentDB (with MongoDB Compatibility)](https://d1.awsstatic.com/whitepapers/getting-started-with-amazon-documentdb.pdf)

## FAQs
1. [Amazon Aurora FAQ](https://aws.amazon.com/rds/aurora/faqs/)
3. [Amazon DocumentDB (with Mongo Compatibility) FAQ](https://aws.amazon.com/documentdb/faqs/)
4. [Amazon DynamoDB FAQ](https://aws.amazon.com/dynamodb/faqs/)
5. [Amazon ElastiCache FAQ](https://aws.amazon.com/elasticache/faqs/)
6. [Amazon Neptune FAQ](https://aws.amazon.com/neptune/faqs/)
7. [Amazon Quantum Ledger Database (QLDB) FAQ](https://aws.amazon.com/qldb/faqs/)
8. [Amazon Relational Database Service (RDS) FAQ](https://aws.amazon.com/rds/faqs/)
9. [Amazon Redshift FAQ](https://aws.amazon.com/redshift/faqs/)
10. [Amazon Database Migration Service FAQ](https://aws.amazon.com/dms/faqs/)

## Exam Registration and Scheduling
1. [Exam Details](https://aws.amazon.com/certification/certified-database-specialty/)
...
2. [Schedule Your Exam](https://www.aws.training/certification?src=db-spec)
